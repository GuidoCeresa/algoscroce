...
//        testo = 'Algos© - 5.23 del 10 dicembre 2015'
//        testo = 'Algos© - 5.24 del 19 dicembre 2015'
//        testo = 'Algos© - 5.25 del 20 gennaio 2016'
//        testo = 'Algos© - 5.26 del 6 novembre 2016'
//        testo = 'Algos© - 5.27 del 13 dicembre 2016'
        testo = 'Algos© - 5.28 del 16 febbario 2017'
...
//                testoOut += formRiga('Località', Lib.presentaDataCompleta(turno.giorno))
    ...
    private String listaMiliteFunzioni(Turno turno, boolean usaListaMilitiViaggi, int pos) {
        ...
        if (usaListaMilitiViaggi) {
            ...
            if (funz) {
                if (milite) {
                    testoOut += LibHtml.field(Field.txt, funz.descrizione, milite.cognomeNome, "")
                } else {
